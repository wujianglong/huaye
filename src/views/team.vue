<template>
  <div class="profile">
    ...
    <div>
      <div class="route tal">
        <div class="common">
          <router-link to="/" tag="span">首页</router-link> > <span>团队风采</span>
        </div>
      </div>
      <div class="page_main common layoutFlex">
        ...
        <div class="page_content">
          ...
          <div class="tal">
            <div class="tac">
              <img class="mb6" src="../static/images/team/team1.png" alt="">
              <img class="mb6"  src="../static/images/team/team3.png" alt="">
